<p id="badge-template" class="yayblog-template">
    
        <?php 
            if($custom_rating !== ''){?>
            <span>
                <svg fill="#ffc71a" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24">
